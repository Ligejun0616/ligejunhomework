...
bool Name_sort(const student& t1, const student & t2)                                 //实现姓名比较的功能
{
    if (t1.Name>t2.Name)
        return 1;
    else
...
bool Score1_sort(const student& t1, const student & t2)                                //实现课程1比较的功能
{
...
bool Score2_sort(const student& t1, const student & t2)                                //实现课程2比较的功能
{
